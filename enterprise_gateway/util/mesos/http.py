...
Ref - http://mesos.apache.org/documentation/latest/endpoints/
"""
...
class Resource(object):
    ...
    def get_frameworks(self):
        ...
        is list of framework IDs for all completed frameworks
        TODO - optimize this by leveraging /frameworks?framework_id=FRAMEWORK_ID
        """
    ...
    def _create_post_data(self, request_type):
        return ujson.dumps({"type": request_type})

...
from enterprise_gateway.services.util.mesos import http
...
class TestHttpRequest(unittest.TestCase):
        ...
        [(None,
         ...
         (10,
          ...
          [mock.call(auth=None,
                     ...
                     timeout=100,
                     url='http://some.domain/some/prefix')])])
    def test_resource_request(self, default_tos, override_tos,
                              expected_request_calls):
        # test request
        with mock.patch('enterprise_gateway.services.util.mesos.http.requests.request',
                        autospec=True) as mock_mesos_http_request:
    ...
    def test_resource_request_json(
        ...
        with mock.patch('enterprise_gateway.services.util.mesos.http.requests.request',
                        autospec=True) as mock_mesos_http_request:
            with mock.patch('enterprise_gateway.services.util.mesos.http.ujson.loads',
                            autospec=True) as mock_ujson_loads:
    ...
    def test_resource_get_json(self):
        with mock.patch('enterprise_gateway.services.util.mesos.http.requests.request',
                        autospec=True) as mock_mesos_http_request:
    ...
    def test_resource_post_json(self):
        with mock.patch('enterprise_gateway.services.util.mesos.http.requests.request',
                        autospec=True) as mock_mesos_http_request:

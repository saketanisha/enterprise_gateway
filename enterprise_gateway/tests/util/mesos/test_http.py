...
class TestHttpRequest(unittest.TestCase):
    ...
    def test_resource(self):
        ...
        assert subresource.url.geturl() == 'http://some.domain/some/prefix/some/subpath'
    ...
    def test_resource_request(self, default_tos, override_tos,
        ...
        # test request
        with mock.patch('enterprise_gateway.util.mesos.http.requests.request',
    ...
    def test_resource_request_json(
        ...
        with mock.patch('enterprise_gateway.util.mesos.http.requests.request',
                        autospec=True) as mock_mesos_http_request:
            with mock.patch('enterprise_gateway.util.mesos.http.ujson.loads',
